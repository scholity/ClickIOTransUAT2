({
    ...
    editOffering : function(component, event, helper) {
        ...
        //component.set("v.cpsWrap.accId",component.get('v.cpsWrap.accId');
        ...
        component.set("v.cpsWrap.clsId",offering.clsId);
        component.set("v.cpsWrap.timeZone",offering.timeZone);

        if(offering.geoLat===undefined || offering.geoLng===undefined)
        {
         	component.set("v.cpsWrap.geoLat",'');
       	 	component.set("v.cpsWrap.geoLng",'');
        }
        else{
		...
		helper.getLearningPlanAttributesByName(component, event, helper);
        //helper.requiredSchedule(component,event,helper);
    ...
    onclickNext : function(component,event,helper){
        ...
        if(currentSN == "One")            
        {
            helper.requiredSchedule(component,event,helper);
            helper.formatTime(component,event,helper);
            helper.validateFields(component,event,helper); //issue
            helper.getGeocode(component,event,helper);
            helper.createIltLocation(component); 
            console.log(JSON.stringify(component.get('v.cpsWrap.sessionList')));
			...
			*/            
            if(component.get("v.allValid") == true  && component.get("v.isUrlValid") && !component.get("v.orgError")){
                document.getElementById("Accspinner").style.display = "block";
                component.set("v.showError","false");
                component.set("v.errorMessage","");
                //alert('all valid call updateClass');
                helper.updateClass(component, event, helper);
    ...
    showDashboard : function(component,event,helper){
        component.set("v.stepNumber", "Dashboard");
    },
	...
	accountSelected : function (component,event,helper){
        		...
        		//alert(JSON.stringify(v.selectedLookUpRecord1));
